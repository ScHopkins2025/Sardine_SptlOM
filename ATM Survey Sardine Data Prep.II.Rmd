...
LifeHistoryHaulCatch <- LifeHistoryHaulCatch %>%
  mutate(haulback_time = ymd_hms(haulback_time, tz = "America/Los_Angeles"),
         equilibrium_time = ymd_hms(equilibrium_time, tz = "America/Los_Angeles"))
...
LifeHistorySpecimen <- LifeHistorySpecimen %>%
  mutate(equilibrium_time = ymd_hms(time, tz = "America/Los_Angeles")) %>%
  select(-time)
...
# [16] "mantle_length"          "equilibrium_time"       "start_latitude"        
# [19] "start_longitude"        "stop_latitude"          "stop_longitude"        
# [22] "haulback_time"          "surface_temp"           "surface_temp_method"   
# [25] "ship_spd_through_water" "subsample_count"        "subsample_weight"      
# [28] "remaining_weight"       "presence_only"          "beginTransect"         
# [31] "endTransect"     
...
Haul.weights <- 
  Haul.weights[,c("scientific_name","quality.indic","FID","subsample_count",
                  ...
                  "stop_latitude","stop_longitude","equilibrium_time","haulback_time",
...
# [1] "2003-07-12 08:52:00 PDT" "2024-08-03 10:27:00 PDT"
...
Haul.weights %>%
  ...
  fwrite(., paste(here(dir), "/Data", survey.path,
                  "ATM.Survey.extra.sample.observation.errors.csv", sep = ""),
       sep = ",")
...
# [1] "2003-07-10 07:36:00 PDT" "2024-08-03 10:27:00 PDT"
...
# [1] "2003-07-10 07:36:00 PDT" "2019-06-30 05:55:00 PDT"
...
# [1] "2004-03-17 12:37:00 PST" "2004-03-17 12:37:00 PST"
...
fwrite(check3.1, paste(here(dir), "/Data", survey.path,
...
# [1] "2003-07-20 11:13:00 PDT" "2003-07-20 11:13:00 PDT"
...
Haul.weights.rev2 <- Haul.weights.rev %>%
  ...
  filter(!collection %in% Haul.weights.rev.1.1$collection &
           !collection %in% check3.1$collection) %>%
...
fwrite(Cleaned.data, paste(here(dir), "/Data", survey.path,
                           "2003.2024.ATM.Survey.csv", 
                           sep = ""), 
       sep = ",")
