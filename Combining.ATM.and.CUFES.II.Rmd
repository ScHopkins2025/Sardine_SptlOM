...
color.values <- c(setNames(group.colors, names(group.colors)),
                  "Absence of Sardine Eggs" = "darkgrey",
                  "Absence of Sardine in Trawl" = "darkgrey",
                  setNames(season.colors, names(season.colors)))

fill.values <- c(setNames(group.colors, names(group.colors)),
...
cpue.by.lat.OM.1 <-  
  ...
  geom_point(data = Present.OM.1,
             aes(x = tim_stp, 
                 ...
                 color = notation_type, 
                 fill = notation_type, 
                 shape = notation_type, fill = notation_type),
             size = 1.5) +
...
ggsave2(filename="cpue.by.lat.OM.1.jpeg", 
        plot=cpue.by.lat.OM.1,
        device="jpeg",
        path=paste(dir,"/Final.OM.spatial.structure/Figures",sep=""),
...
ggsave2(filename="cpue.by.lat.OM.2.jpeg", 
        plot=cpue.by.lat.OM.2,
        device="jpeg",
        path=paste(dir,"/Final.OM.spatial.structure/Figures",sep=""),
        dpi=1200, width = 29, height=21, unit="cm", limitsize = FALSE)
...
ggsave2(filename="cpue.by.lat.OM.3.jpeg", 
        plot=cpue.by.lat.OM.3,
        device="jpeg",
        path=paste(dir,"/Final.OM.spatial.structure/Figures",sep=""),
        dpi=1200, width = 29, height=21, unit="cm", limitsize = FALSE)
...
ggsave2(filename="cpue.by.lat.OM.4.jpeg", 
        plot=cpue.by.lat.OM.4,
        device="jpeg",
        path=paste(dir,"/Final.OM.spatial.structure/Figures",sep=""),
        dpi=1200, width = 29, height=21, unit="cm", limitsize = FALSE)
...
ggsave2(filename="cpue.by.lat.OM.5.jpeg", 
        plot=cpue.by.lat.OM.5,
        device="jpeg",
        path=paste(dir,"/Final.OM.spatial.structure/Figures",sep=""),
        dpi=1200, width = 29, height=21, unit="cm", limitsize = FALSE)
...
ggsave2(filename="cpue.by.lat.OMs.jpeg", 
        plot=cpue.by.lat.OMs,
        device="jpeg",
        path=paste(dir,"/Final.OM.spatial.structure/Figures",sep=""),
        dpi=1200, width = 29, height=21, unit="cm", limitsize = FALSE)
