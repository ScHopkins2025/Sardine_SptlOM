...
summary(lm(Density ~ est, data = pTrain0))$r.squared # 0.2385033
summary(lm(Density ~ est, data = pTest0))$r.squared # 0.00090351

# MAE
mean(abs(pTrain0$Density - pTrain0$est)) # 24.98654
mean(abs(pTest0$Density - pTest0$est)) # 62.75438
